...
# curl -X GET http://localhost:8080/api/users/all \
#   -H "Authorization: Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxZjc4ZjU5OS00YmVhLTQxOWItOGFhMy04ZTA5MzRlNmZmNzYiLCJpYXQiOjE3NjI0NTUyMjUsImV4cCI6MTc2MjU0MTYyNX0.Th0jBPGr3NqdeK0mry1EY4jt04mAuOqq63tpWe8E4CY" \
#   -v
